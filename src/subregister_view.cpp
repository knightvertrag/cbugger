...
namespace cbg
{
    ...
    SubregisterView make_vn_lane_s(uint8_t n, uint8_t lane, user_fpsimd_state &fpr, bool zero_upper)
    {
        SubregisterView sv{};
        sv.name = nullptr;
        sv.format = RegisterFormat::F32;
    ...
    SubregisterView make_vn_lane_d(uint8_t n, uint8_t lane, user_fpsimd_state &fpr, bool zero_upper)
    {
        SubregisterView sv{};
        sv.name = nullptr;
        sv.format = RegisterFormat::F64;
